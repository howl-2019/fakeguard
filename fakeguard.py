...
def main():
    ...
    all_result_imgs = poison_generator.generate_one(src_image_path, target_image_path)
...
def parse_arguments(argv):
    ...
    parser.add_argument('-s', '--source', type=str, default='')  # 경로 문자열
    parser.add_argument('-t', '--target', type=str, default='')  # 경로 문자열
